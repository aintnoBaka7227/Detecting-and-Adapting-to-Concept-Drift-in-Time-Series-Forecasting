"""NHITS + KSWIN + RetrainUsing3MonthWindows adaptation arm -- SA1 only.
...
`run_aemo_nhits_retrain3mo_kswin_nsw.py` is NSW1's twin (duplicated per
this project's `run_*.py` convention). `split_id="aemo_nhits_retrain3mo_kswin_v1"`
