...
evaluation.match_unmatch() / evaluation.calculate_event_metrics(), persists
detection timestamps through results_io, and appends the resulting metric
rows to results/runs.csv.
"""
...
def run_input(
    ...
    for detector in make_frozen_detectors():
        ...
        #
        # record_run()
        #   -> evaluation.match_unmatch() / evaluation.calculate_event_metrics()
